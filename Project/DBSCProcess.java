...
class DBSCProcess extends JDialog implements ActionListener
{
  JLabel lbltitle;
  ...
  DBSCProcess(MainMenu mainmenu)
  {
    super(mainmenu, "Dependency Based Service Consolidation (DBSC) Process",true);
    ...
    lbltitle = new JLabel("Dependency Based Service Consolidation (DBSC) Process",JLabel.CENTER);
    ...
    jtab = new JTable(mainmenu.servcount,4);
  ...
  public void assignData()
  {
    ...
    {
      Screen.showMessage("Error : DBSCProcess - assignData : "+e);
    }
  }
}
